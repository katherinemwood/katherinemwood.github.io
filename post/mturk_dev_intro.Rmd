...
##### On Windows
If you are on windows, you need to install Python 2. You can find Python's download link [here](https://www.python.org/downloads/release/python-2714/). You'll want to select `Windows x86 MSI Installer`.
