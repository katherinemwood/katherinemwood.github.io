...
In this simulation, we're doing a basic, between-groups t-test and drawing samples from the normal distribution. The code can be dead simple. I'll write a tiny 
