...
Also, yes, I'm loading 5 packages to make one graph.
...
This graph doesn't match up perfectly with what I would have thought. The difference is pretty substantial at the lower sample sizes, but there's not as stark a difference at the larger sample sizes.
